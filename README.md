...
**95 modules** across seven categories, a full CV/modulation system, MIDI,
...
- **95 modules** in seven Add-menu categories:
...
├── modules/         # The 95 module type definitions — ports & params, no DSP
