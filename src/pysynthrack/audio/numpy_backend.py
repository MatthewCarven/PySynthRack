...
from .renderers import ClockworkRenderers, DynamicsRenderers, ModFXRenderers
...
class NumpyBackend(ClockworkRenderers, DynamicsRenderers, ModFXRenderers, AudioBackend):
