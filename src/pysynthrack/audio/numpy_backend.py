...
from .renderers import ClockworkRenderers, DynamicsRenderers, ModFXRenderers, ReverbDelayRenderers
...
class NumpyBackend(ClockworkRenderers, DynamicsRenderers, ModFXRenderers, ReverbDelayRenderers, AudioBackend):
